...
2. Install dependencies:
   ...
   pip install -r requirements.txt
   ```
3. Verify setup by opening the Jupyter notebook:
   ```bash
...
1. Open `MOFARO_Simulation.ipynb` in Jupyter Notebook.
2. Run all cells to execute the simulation with default parameters:
   - `NUM_TASKS = 50`
...
- Seyed Ali Hosseini: [ali.hosseini1822@iau.ac.ir](mailto:ali.hosseini1822@iau.ac.ir)
- Omid Sojoodi Shijani: [o_sojoodi@iau.ac.ir](mailto:o_sojoodi@iau.ac.ir)
- Vahid Khajehvand: [vahidkhajehvand@iau.ac.ir](mailto:vahidkhajehvand@iau.ac.ir)
